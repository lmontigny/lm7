...
![LM7 in five layers: the PyTorch model, the LM7 orchestrator, backends per target, lowering and runtime, and the hardware, with one column per vendor](docs/figures/lm7-architecture.svg)
