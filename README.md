...
<picture>
  ...
  <img alt="LM7 in five layers for Intel, AMD, NVIDIA and Apple: model, orchestrator, backends per target, lowering and runtime, hardware" src="docs/figures/lm7-compute-light.svg">
</picture>
...
machine you actually have; the target string on each card is what selects it.

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/figures/lm7-edge-dark.svg">
  <img alt="LM7 in five layers for Arm, Google TPU, Tenstorrent and Qualcomm Snapdragon" src="docs/figures/lm7-edge-light.svg">
</picture>

Both figures are generated by `docs/figures/generate_architecture.py`, so a
target or backend is corrected in one table rather than redrawn.
