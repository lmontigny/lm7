...
- [torch.compile modes on sm89](torch-compile-modes.md) — why the headline number
  is CUDA Graphs rather than codegen, how it decays to a slowdown as context
  grows, and the two ways the timing loop misreports it.
