...
| [#219](https://github.com/lmontigny/lm7/pull/219) | Benchmark realistic RTX compiled generation |
| [#222](https://github.com/lmontigny/lm7/pull/222) | Separate what torch.compile wins from how the timing loop measures it |
